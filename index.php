        ...
        <div id="content">
            <div id="hobi" class="card1">
                ...
                <article class="card mb-4">
                    <h3 style="text-align: center;">Soal 1</h3>
                    <a href="<?php echo "1.php" ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lihat Jawaban Soal 1</a>
                </article>
                <article class="card mb-4">
                    <h3 style="text-align: center;">Soal 2</h3>
                    <a href="<?php echo "2.php" ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lihat Jawaban Soal 2</a>
                </article>
                <article class="card mb-4">
                    <h3 style="text-align: center;">Soal 3</h3>
                    <a href="<?php echo "3.php" ?>" class="btn btn-primary btn-lg active" role="button">Lihat Jawaban Soal 3</a>
                </article>
                <article class="card mb-4">
                    <h3 style="text-align: center;">Soal 4</h3>
                    <a href="<?php echo "login.php" ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lihat Jawaban Soal 4</a>
                </article>
            </div>
        </div>
