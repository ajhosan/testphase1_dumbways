...
<body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item active" href="<?php echo "2.php" ?>">Soal 2</a>
    ...
    <main>
        <div class="jumbotron jumbotron-fluid" style="background-color:yellow;">
            <div class="container">
                <h2 class="display-4">Tugas Nomor 2</h2>
        ...
        <div id="content">
            <div id="hobi" class="card1">
                ...
                <article class="card mb-4">
                    <img src="assets/img/soal_nomor2.png" alt="" width="100%">
                </article>
                ...
                <article class="card">
                    ...
                    $nilai = array(array(2, 8, 14, 20, 26), array(32, 38, 44, 50, 56), array(62, 68, 74, 80, 86));
                    ?>
                    <br>
                    <h3>Output</h3>
